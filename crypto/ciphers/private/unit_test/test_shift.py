#!/usr/bin/python3
# Title: Unit Test for Shift Cipher
...
import unittest
from crypto.ciphers.private.shift import shift

class TestOneTimePad(unittest.TestCase):
    def test_one_time_pad_encrypt_1(self):
    ...
    def test_one_time_pad_decrypt_1(self):
