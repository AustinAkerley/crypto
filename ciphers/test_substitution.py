...
class TestSubstitutionCipher(unittest.TestCase):
    def test_substituion_cipher_decrypt_1(self):
        ...
        key = 5
        sub_cipher = substitution.substitution(key, None, cipher_text)
    ...
    def test_substituion_cipher_encrypt_1(self):
        ...
        key = 5
        sub_cipher = substitution.substitution(key, plain_text, None)
        sub_cipher.encrypt()
        print("Actual Output:")
        print(sub_cipher.cipher_text)
        print("Expected Output:")
    ...
    def test_substituion_cipher_encrypt_2(self):
        ...
        key = 5
        sub_cipher = substitution.substitution(key, plain_text)
        sub_cipher.set_key(10)
        sub_cipher.encrypt()
        print("Actual Output:")
        print(sub_cipher.cipher_text)
    ...
    def test_substituion_cipher_encrypt_4(self):
        ...
        key = 5
        sub_cipher = substitution.substitution(key, plain_text, None, "alphabetic")
        sub_cipher.encrypt()
        print("Actual Output:")
        print(sub_cipher.cipher_text)
        print("Expected Output:")
